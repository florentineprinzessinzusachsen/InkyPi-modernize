...
def test_action_buttons_disabled_when_api_key_missing(client, device_config_dev):
    ...
    # "Save defaults" should NOT be disabled.  JTN-506 added HTMX attributes
    ...
    assert ">Save defaults</button>" in body
    # Between the save-settings-help anchor and "Save defaults" text, the
