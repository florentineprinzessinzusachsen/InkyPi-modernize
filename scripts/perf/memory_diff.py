...
Unlike ``scripts/install_testing/test_install_memcap.sh`` (JTN-608, which samples RSS of the
...
Usage:
    python scripts/perf/memory_diff.py --output pr.json
    python scripts/perf/memory_diff.py --backend tracemalloc --output base.json
"""
