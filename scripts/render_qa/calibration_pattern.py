...
Usage:
    python scripts/render_qa/calibration_pattern.py --width 800 --height 480
    python scripts/render_qa/calibration_pattern.py --profile grayscale --output-dir /tmp/cal
    python scripts/render_qa/calibration_pattern.py --profile mono --width 400 --height 300
