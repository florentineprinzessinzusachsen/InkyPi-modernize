...
Usage:
    python scripts/render_qa/image_diff.py IMAGE_A IMAGE_B
    python scripts/render_qa/image_diff.py IMAGE_A IMAGE_B --output /tmp/diff.png
    python scripts/render_qa/image_diff.py IMAGE_A IMAGE_B --threshold 10
    python scripts/render_qa/image_diff.py IMAGE_A IMAGE_B --summary-only
    python scripts/render_qa/image_diff.py IMAGE_A IMAGE_B --json
