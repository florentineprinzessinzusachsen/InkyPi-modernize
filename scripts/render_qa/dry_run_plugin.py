...
Usage examples (run from repo root):
  python scripts/render_qa/dry_run_plugin.py --plugin year_progress
  python scripts/render_qa/dry_run_plugin.py --plugin clock --width 640 --height 400
  python scripts/render_qa/dry_run_plugin.py --plugin year_progress --config /tmp/my_settings.json
  python scripts/render_qa/dry_run_plugin.py --plugin weather --output /tmp/weather.png
"""
