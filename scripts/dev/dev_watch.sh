...
#
# Behavior
#   - src/static/styles/    → runs `python3 scripts/build/build_css.py`
#   - src/static/scripts/   → runs `python3 scripts/build/build_assets.py` (JS bundle)
...
Then re-run ./scripts/dev/dev_watch.sh
EOF
  exit 1
fi
