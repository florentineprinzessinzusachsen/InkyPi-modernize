...
Usage:
    python scripts/build/build_css.py            # concatenate only
    python scripts/build/build_css.py --minify   # concatenate + minify
    python scripts/build/build_css.py --check    # verify round-trip (no write)
...
STYLES_DIR = Path(__file__).resolve().parent.parent.parent / "src" / "static" / "styles"
